package com.baro.elasticsearch.search.utils;
...
public final class SearchUtils {
    ...
    public static SearchRequest buildSearchRequest(final String indexName,
        ...
        final SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder().postFilter(getQueryBuilder(searchRequestDTO));
